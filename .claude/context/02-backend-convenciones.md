...
Aplica a `backend/`. Complementa `CLAUDE.md`. Donde esto contradiga a
`docs/arquitectura/`, manda esto (son desvíos acordados con el usuario).
...
separadas; detalle y motivo en `.claude/specs-backend/design.md` §13:
